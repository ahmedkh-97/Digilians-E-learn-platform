...
export {EXAM_MODE_IDS,resolveExamMode} from './exam-modes.js?v=0.22.8';

import {createFreshExamSession,restoreExamSession} from './exam-session.js?v=0.22.8';
...
export {
  ...
  moveQuestionIndex,
  setQuestionIndex
} from './exam-navigation.js?v=0.22.8';

export {examTimerPolicyLabel} from './exam-timer.js?v=0.22.8';
...
} from './exam-persistence.js?v=0.22.8';

export {
  feedbackStateForQuestion,
  voucherSelectionStatusText,
  isMultiSelectQuestion
} from './exam-feedback.js?v=0.22.8';
