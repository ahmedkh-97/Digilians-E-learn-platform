import './pl300-source-practice-selection-guard.js?v=0.22.8';
import {
...
export function ensureNativePracticeStyles(doc=globalThis.document){
  ...
  link.rel='stylesheet';
  link.href='assets/css/source-practice-native.css?v=0.22.8';
