...
test('V0.22.8 cache-integrity release has a distinct release identity so browsers cannot reuse older modules',()=>{
  ...
  assert.match(updateManager,/FALLBACK_RELEASE=\{version:"0\.22\.8"/);
